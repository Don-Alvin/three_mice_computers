...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_products_stock_status" AS ENUM('in-stock', 'out-of-stock', 'on-order');
  CREATE TYPE "public"."enum_categories_group" AS ENUM('computing', 'storage', 'networking-cctv', 'accessories', 'cables-power');
  ...
  CREATE TABLE "products" (
  	...
  	"stock_status" "enum_products_stock_status" DEFAULT 'in-stock' NOT NULL,
